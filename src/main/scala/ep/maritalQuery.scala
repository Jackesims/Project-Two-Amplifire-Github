...
object maritalStatus {
    ...
    //val df1 = spark.read.option("header", true).option("inferSchema", true).csv("/user/maria_dev/merged_data.csv")
    ...
    var res1 = parqDF2.filter("detail_age > 18").count(); // Total number of individuals
